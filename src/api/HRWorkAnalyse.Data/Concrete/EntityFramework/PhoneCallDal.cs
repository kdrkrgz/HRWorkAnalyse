...
{
    public class PhoneCallDal: EfEntityRepositoryBase<HrWorkAnalyseDbContext, PhoneCall>, IPhoneCallDal
    {
        public PhoneCallDal(HrWorkAnalyseDbContext context):base(context)
        {
